...
export function ProgressSummaryCard({ summary, error }: ProgressSummaryCardProps) {
  if (error) {
    return (
      <Card title="Progress summary" description="Your recent cricket activity at a glance.">
  ...
  if (!summary.hasAnyData) {
    return (
      <Card
        ...
        description="Your recent cricket activity at a glance."
    ...
    <Card title="Progress summary" description="Your recent cricket activity at a glance.">
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <SummaryItem
          ...
          value={String(summary.trainingSessionsThisWeek)}
        />
        <SummaryItem
          label="Matches this week"
          value={String(summary.matchesThisWeek)}
        />
